...
class VoyagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voyage" do
    assert_difference('Voyage.count') do
      post voyages_url, params: { voyage: { ata: @voyage.ata, atd: @voyage.atd, eta: @voyage.eta, etd: @voyage.etd, numberin: @voyage.numberin, numberout: @voyage.numberout, terminal_id: @voyage.terminal_id, vessel_id: @voyage.vessel_id } }
    end
  ...
  test "should update voyage" do
    patch voyage_url(@voyage), params: { voyage: { ata: @voyage.ata, atd: @voyage.atd, eta: @voyage.eta, etd: @voyage.etd, numberin: @voyage.numberin, numberout: @voyage.numberout, terminal_id: @voyage.terminal_id, vessel_id: @voyage.vessel_id } }
