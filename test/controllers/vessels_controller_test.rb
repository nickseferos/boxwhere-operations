...
class VesselsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vessel" do
    assert_difference('Vessel.count') do
      post vessels_url, params: { vessel: { length_overall: @vessel.length_overall, name: @vessel.name, steamship_line_id: @vessel.steamship_line_id } }
    end
  ...
  test "should update vessel" do
    patch vessel_url(@vessel), params: { vessel: { length_overall: @vessel.length_overall, name: @vessel.name, steamship_line_id: @vessel.steamship_line_id } }
