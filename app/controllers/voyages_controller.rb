class VoyagesController < ApplicationController
  ...
  # GET /voyages.json
  def index
    @voyages = Voyage.all.where(departed: false).order(eta: :desc)
  end
  ...
  private
    ...
    def voyage_params
      params.require(:voyage).permit(:job_number, :numberin, :numberout, :eta, :etd, :ata, :atd, :terminal_id, :vessel_id, :departed)
    end
end
